...
-----------------------------------------------------------------------------------------------------------------------
In this paper, I (with [Denis Werth](https://www.iap.fr/useriap/werth/) and [Will Handley](https://www.willhandley.co.uk/)) developed analytical expressions for primordial power spectra in inflationary models with spatial curvature. We showed how curvature modifies the scalar perturbation spectrum and provided approximations that match fully numerical calculations. These results help interpret how spatial curvature could leave imprints on large-scale CMB anisotropies, and provide tools to test curvature with observational data. This work also laid the groundwork for extensions to tensor modes (see [arXiv:2511.10644](https://arxiv.org/abs/2511.10644)) and connects to debates on whether our universe is exactly flat or slightly curved (see e.g. [arXiv:1911.02087](https://arxiv.org/abs/1911.02087)).
